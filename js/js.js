$('.sidebar ul li').eq(0).hover(function() {
	$(this).children().children('img').attr('src', 'images/eej_03.jpg')
})
$('.sidebar ul li').eq(0).mouseleave(function() {
	$(this).children().children('img').attr('src', 'images/actnavbar_101.jpg')
})
$('.sidebar ul li').eq(1).hover(function() {
	$(this).children().children('img').attr('src', 'images/seac_061.jpg')
})
$('.sidebar ul li').eq(1).mouseleave(function() {
	$(this).children().children('img').attr('src', 'images/actnavbar_103.jpg')
})
$('.sidebar ul li').eq(2).hover(function() {
	$(this).children().children('img').attr('src', 'images/seac_03.jpg')
})
$('.sidebar ul li').eq(2).mouseleave(function() {
	$(this).children().children('img').attr('src', 'images/actnavbar_10.jpg')
})
